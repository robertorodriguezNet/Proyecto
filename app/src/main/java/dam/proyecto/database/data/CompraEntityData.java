...
public class CompraEntityData {
    ...
    private static final CompraEntity[] TAG_DATA = {
            ...
            new CompraEntity("8480000505460","2208180819", (float)1,(float)2.65,(float)2.65, (float)8.84),
            new CompraEntity("8480000512239","2208180819", (float)1,(float)1.15,(float)1.15, (float)3.84),

            new CompraEntity("8410500008871","2208251944", (float)2,(float)6.78,(float)3.39, (float)3.53125),
            new CompraEntity("8480000103833","2208251944", (float)1,(float)4.62,(float)4.62, (float)0.77),
            new CompraEntity("8480000505460","2208251944", (float)1,(float)2.65,(float)2.65, (float)8.84),
            new CompraEntity("8437003018008","2208251944", (float)1,(float)0.73,(float)0.73, (float)0.09125),
            new CompraEntity("8480000180025","2208251944", (float)1,(float)4.65,(float)4.65, (float)12.92),
            ...
            new CompraEntity("8480024292193","2302200921", (float)1,(float)1.29,(float)1.29, (float)0.33),
            new CompraEntity("8480024750600","2302200921", (float)1,(float)1.99,(float)1.99, (float)50),
            new CompraEntity("8480024819055","2302200921", (float)3,(float)2.25,(float)0.75, (float)3.00),

            new CompraEntity("1000087865444","2303231858", (float)0.778,(float)1.05,(float)1.35, (float)1.35),
            new CompraEntity("1000000002348","2303231858", (float)0.888,(float)1.50,(float)1.69, (float)1.69),
            new CompraEntity("24002042","2303231858", (float)1,(float)1.69,(float)1.69, (float)8.45),
            new CompraEntity("24031486","2303231858", (float)2,(float)0.65,(float)1.30, (float)2.60),
            new CompraEntity("1000534544661","2303231858", (float)1,(float)2.21,(float)2.21, (float)0.19),
