...
public class ProductoData {
    ...
    private static final ProductoEntity[] PRODUCTO_DATA = {
            ...
            new ProductoEntity("8480000221636", "Cafe soluble natural classic tarro 200 g", 9, 1, "k", (float) 0.2),
            new ProductoEntity("8480000260284", "Alubia Blanca Hacendado 295 g", 9, 1, "k", (float) 0.21),
            new ProductoEntity("8480000260390", "Garbanzo cocido", 9, 1, "k", (float) 0.21),
            ...
            new ProductoEntity("8480000592477", "Pechuga pavo bajo sal", 9, 1, "k", (float) 0.225),
            new ProductoEntity("8480000823021", "Pan molde de centeno 14 rebanadas - 720 g", 9, 14, "k", (float) 0.72),
            ...
            new ProductoEntity("8480000837837", "Panecillo horno paquete 11 u - 495 g", 9, 11, "k", (float) 0.495),
            new ProductoEntity("8411396000734", "Fflautas pollo y queso 2 u - 273 g", 10, 2, "k", (float) 0.273),
            ...
            new ProductoEntity("8437003894275", "Paleta Curada Lonchas 240g Bipack", 16, 1, "k", (float) 0.24),
            ...
            new ProductoEntity("3600542379342", "tinte pelo 5.0 castaño", 30, 1, "u", (float) 1.0),
            new ProductoEntity("8480000622129", "merluza congelada", 9, 1, "k", (float) 0.4),
            new ProductoEntity("1000534544671", "calabacín", 8, 0, "a", (float) 0.0),
            new ProductoEntity("8480000038524", "Guacamole", 9, 1, "k", (float) 0.2),
