...
public class ProductoData {
    ...
    private static final ProductoEntity[] PRODUCTO_DATA = {
            ...
            new ProductoEntity("8480000180025","Atún Claro Aceite Oliva Pack-6 480 GR",9,6,"k",(float)0.36),
            new ProductoEntity("8480000221636","Cafe soluble natural classic",9,1,"k",(float)0.2),
            new ProductoEntity("8480000260284","Alubia Blanca Hacendado 295 g",9,1,"k",(float)0.21),
            new ProductoEntity("8480000260390","GARBANZO COCIDO 400 g",9,1,"k",(float)0.21),
            ...
            new ProductoEntity("8480000823021","Pan molde de centeno",9,14,"k",(float)0.72),
            ...
            new ProductoEntity("8480000837837","Panecillo horno 1ud",9,11,"k",(float)0.495),
            new ProductoEntity("8411396000734","Flautas pollo y queso",10,2,"k",(float)0.273),
            ...
            new ProductoEntity("8437003894275","Paleta Curada Lonchas",16,1,"k",(float)0.24),
